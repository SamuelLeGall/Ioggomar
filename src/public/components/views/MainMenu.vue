...
import settingsMapping from "@src/public/config/mappings/settingsMapping.json";
import SelectChangeData from "@src/public/components/UI/UIElements/inputs/Special/SelectChangeData/SelectChangeData.vue";
