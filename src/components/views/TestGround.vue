...
import QuestsList from "@components/UI/modules/quests/QuestsList.vue";
...
import InventoryContainer from "@components/UI/modules/inventory/InventoryContainer.vue";
